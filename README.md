...
```
Train the model by 7 labeled data of chinesepaintings dataset:
```
python train.py --dataset chinesepaintings --num-labeled 7 --arch wideresnet --batch-size 64 --lr 0.0003 --expand-labels --seed 5 --out results/wrns100-10
```
